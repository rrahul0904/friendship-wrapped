...
export const STORY_THEMES: Record<StoryThemeId, StoryTheme> = {
  midnight: {
    id: "midnight",
    label: "Midnight",
    background: ["#17122b", "#452f74", "#8a4f8e"],
  ...
  sunset: {
    id: "sunset",
    label: "Sunset",
    background: ["#3b173f", "#b43c68", "#f29a5b"],
    surface: "rgba(255,255,255,.12)",
    foreground: "#fffaf7",
    accent: "#ffd7a8",
    muted: "rgba(255,250,247,.76)",
  },
  paper: {
    id: "paper",
    label: "Paper",
    background: ["#f5efe4", "#eee1cb", "#d9c6a7"],
    surface: "rgba(255,255,255,.42)",
    foreground: "#2b241c",
    accent: "#7c5332",
    muted: "rgba(43,36,28,.68)",
  },
  neon: {
    id: "neon",
    label: "Neon",
    background: ["#07131d", "#0c3d49", "#46226f"],
    surface: "rgba(54,255,211,.09)",
    foreground: "#f7fffd",
    accent: "#36ffd3",
